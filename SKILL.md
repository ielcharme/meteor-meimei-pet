...
- **macOS desktop companion:** install or rebuild the transparent menu-bar app that matches the current Codex pet width, walks, waves, jumps, reacts to clicks, and tells occasional offline cold jokes.
